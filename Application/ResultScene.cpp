...
void ResultScene::Draw()
{
	...
	if (step >= 3) {
		...
		goRetryButton.Draw();
		SimpleDrawer::DrawString(goRetryButton.pos.x, goRetryButton.pos.y, 5, "ÉäÉgÉâÉC", { 0, 0, 0, 1 }, "", 32, { 0.5f, 0.5f });
		goTitleButton.Draw();
		SimpleDrawer::DrawString(goTitleButton.pos.x, goTitleButton.pos.y, 5, "èIóπ", { 0, 0, 0, 1 }, "", 32, { 0.5f, 0.5f });
	}
}
